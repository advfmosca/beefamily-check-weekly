...
**Fonte dati**: Windsor.ai (Meta + Google Ads, 22 clienti Bee Family).

Ogni settimana viene pubblicato un nuovo report sotto `docs/<slug-settimana>/index.html`. L'indice in `docs/index.html` linka tutti gli storici in ordine decrescente.
